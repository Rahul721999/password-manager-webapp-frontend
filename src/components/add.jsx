...
const Add = (props) => {
    ...
    async function handlePassGen() {
        const generated_pass = await generate(AuthToken);
...
/*---------------------------------------- Store API call ----------------------------------------*/
async function store(Authtoken, website_name, website_url, username, password) {
